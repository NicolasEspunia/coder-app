    ...
    <div className= "bodyCart">
        ...
        {cartList.length === 0 ? 
            ...
            <div className= "carritoVacio">   
                ...
                <img src= "https://w7.pngwing.com/pngs/618/1013/png-transparent-shopping-cart-online-shopping-empty-cart-angle-logo-shopping-centre.png" className="imgEnCart" alt="carro vacio" />
                        <Link to= {"/"}>
